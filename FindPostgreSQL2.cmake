#https://github.com/mkindahl/pg_extension/blob/master/cmake/FindPostgreSQL.cmake
...
set(PGPATH ENV PGPATH)
if (PGPATH)
	set(PG_CONFIG2 $ENV{PGPATH}/bin/pg_config)
else()
	set(PostgreSQL_ROOT_DIRECTORIES ENV PGROOT ENV PGPATH ${PostgreSQL_ROOT})
	find_program(
	  PG_CONFIG2 pg_config
...
message(STATUS "Found pg_config as ${PG_CONFIG2}")

if(PostgreSQL_FOUND)
  macro(PG_CONFIG2 VAR OPT)
    execute_process(
      COMMAND ${PG_CONFIG2} ${OPT}
      OUTPUT_VARIABLE ${VAR}
      OUTPUT_STRIP_TRAILING_WHITESPACE)
  endmacro()

  pg_config2(_pg_bindir --bindir)
  pg_config2(_pg_includedir --includedir)
  pg_config2(_pg_pkgincludedir --pkgincludedir)
  pg_config2(_pg_sharedir --sharedir)
  pg_config2(_pg_includedir_server --includedir-server)
  pg_config2(_pg_libs --libs)
  pg_config2(_pg_ldflags --ldflags)
  pg_config2(_pg_ldflags_sl --ldflags_sl)
  pg_config2(_pg_ldflags_ex --ldflags_ex)
  pg_config2(_pg_pkglibdir --pkglibdir)
  pg_config2(_pg_libdir --libdir)
  pg_config2(_pg_version --version)
