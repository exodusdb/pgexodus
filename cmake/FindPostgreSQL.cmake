...
#
# 2023-09-17 Steve Bush added a optional 'SUPERUSER false' option to the
# postgresql_create_extension macro to allow CREATE EXTENSION without superuser
# privilege for safe extensions.
  ...
  if(_ext_REGRESS)
    ...
    if(PG_REGRESS)
      add_test(
        NAME ${NAME}
        COMMAND
          #exodus ${PG_REGRESS} --temp-instance=${CMAKE_BINARY_DIR}/tmp_check
          sudo -u postgres ${PG_REGRESS} --temp-instance=/tmp/tmp_check
          --inputdir=${CMAKE_CURRENT_SOURCE_DIR}
          #exodus --outputdir=${CMAKE_CURRENT_BINARY_DIR}
          --outputdir=/tmp
          --load-extension=${NAME}
          ${_ext_REGRESS})
    endif()
